...
def highpass_filter(
    ...
    This function implements a digital high-pass filter using a Butterworth filter design.
    ...
    cutoff_freq : float, optional
        Cutoff frequency in Hz (default: 3500 Hz). Frequencies below this will be attenuated.
    order : int, optional
    ...
    if not os.path.isfile(output_image_path):
        ...
        ax.set_title(f'Highpass Filtered Signal\nOrder {order}, Cutoff: {cutoff_freq:.1f} Hz')
