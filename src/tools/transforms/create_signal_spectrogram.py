...
def create_signal_spectrogram(
    ...
    Args:
        ...
        nperseg (int, optional): Length of each segment for the STFT. Defaults to 1024.
                                 A larger value gives better frequency resolution.
        noverlap (int, optional): Number of points to overlap between segments. 
                                  Must be less than nperseg. Defaults to 800.
    ...
    # Ensure noverlap is less than nperseg, which is a requirement for scipy
    if noverlap >= nperseg:
